...
pfdaControl<-function(...,penalty.method=c('AIC','CV'),minimum.variance = 1e-4, convergence.tolerance = 1e-2, max.iterations=10000, nfolds = 10,	useC=TRUE,binary.k0=100, binary.kr=10, nknots=11){
	structure(list(
